...
CREATE TABLE "uploads" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "description" varchar(255), "attachable_id" integer, "created_at" datetime, "updated_at" datetime, "attached_file_name" varchar(255), "attached_content_type" varchar(255), "attached_file_size" integer, "attached_updated_at" datetime, "attachable_type" varchar(255));
