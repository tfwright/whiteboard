...
class PostsControllerTest < ActionController::TestCase
  ...
  test "creates a post" do
    ...
    assert_difference "Post.count", 1 do
      post :create, :course_id => course.id, :post => FactoryGirl.attributes_for(:post)
    end
  end
  ...
  test "renders form for a new post with errors" do
    ...
    course.students << student
    sign_in student
    post :create, :course_id => course.id, :post => FactoryGirl.attributes_for(:post, :body => "")
    assert_template :new
  end
  ...
  test "displays a post" do
    ...
    course.students << student
    sign_in student
    post = FactoryGirl.create(:post, :course => course)
  ...
  test "records an extra view for each reply when displaying a post" do
    ...
    course.students << student
    sign_in student
    post = FactoryGirl.create(:post, :course => nil, :parent => FactoryGirl.create(:post, :course => course))
